...
print("Loading data for Neural Network weather model...")
...
print("\nEvaluating Neural Network Model on 2026 Test Set...")
...
# Save models
model_path = 'deliverables/neural_network_weather_model.joblib'
scaler_path = 'deliverables/scaler.joblib'
